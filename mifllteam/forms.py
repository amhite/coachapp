...
from mifllteam.models import User
...
class RegistrationForm(FlaskForm):
	...
	teamno = IntegerField('Team Number',
				validators=[DataRequired(), NumberRange(min=0, max=50000)])
	numberofmtgs = IntegerField('Number of Meetings',
